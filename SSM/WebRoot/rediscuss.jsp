...
List<Discuss> rel_list=ds.getByDid(did);
request.setAttribute("rel_list", rel_list);
%>
...
<html>
	...
	<div class="erweima"></div>
		...
		<div class="Main-article">
			...
			<h3 class="title-view"><span class="title-box"><i class="blue tag icon"></i>回复</span></h3>
			<div class="article-box">
  				<div class="ui comments">
  				<c:if test="${user.userName!=null }">
  					<form class="ui reply form" action="discuss/rediscuss.do?nid=${nid}&did=${discuss.id }&uid=${user.id}" method="post">
				    <div class="field">
