<%@page import="com.lzh.domain.Recover"%>
  ...
  <head>
	...
	<div class="logo"><a href="index.jsp"><img src="admin/images/logo.jpg" alt="网站logo" height="40px" width="160px" style="margin-top: 0px"></a></div>
		...
		<div class="wrap">	
			...
			String url = "D:/lzh.sql";  
			boolean check = com.load();  
			if(check){  
			 %>  
			<div class="mesg" style="height: 500px;width: 1000px;text-align: center;line-height: 500px">
				 		<span style="font-size: 20px;color: green">数据库恢复成功!已经导入新的数据库lzhtest</span>
			</div>
			 <%}else{ %>
			<div class="mesg" style="height: 500px;width: 1000px;text-align: center;line-height: 500px">
				 		<span style="font-size: 20px;color: red">数据库恢复失败!</span>
			</div>
			 <%}%>
			</div>
			<div id="dcFooter">
