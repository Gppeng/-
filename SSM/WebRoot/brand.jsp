...
List<News> news_list=ns.getNewsByType("品牌");
List<News> read_list=ns.getByRead();
News maxRead=ns.getMaxByType("品牌");
...
<html>
	...
	<div class="erweima"></div>
		<div class="headBox">
		  <div class="wrap">
		    ...
		    <div class="Menu">
		      <ul>
		        <li class="ln1"><a href="listjsp.do?pageIndex=1&pageNum=10" rel="nofollow">首页</a></li>
	...
	<div class="wrap clearfix mtop20 ColorOfBrand" >
		<!--左侧导航-->
		 <div class="leftNav">
		    <div class="leftNavMain" id="header-nav">
		      <h1><a href="#">品牌</a></h1>
		      <ul>
		        <li><h2><a href="#">大牌</a></h2></li>
		              
		        <li><h2><a href="#">男装</a></h2></li>
		              
		        <li><h2><a href="">女装</a></h2></li>
		              
		        <li><h2><a href="">休闲</a></h2></li>
		              
		        <li><h2><a href="">运动</a></h2></li>
		              
		        <li><h2><a href="">服饰</a></h2></li>
