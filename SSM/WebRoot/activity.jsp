...
List<News> news_list=ns.getNewsByType("活动");
List<News> read_list=ns.getByRead();
News maxRead=ns.getMaxByType("活动");
...
<html>
	...
	<div class="wrap clearfix mtop20 ColorofActivity" >
		<!--左侧导航-->
		 <div class="leftNav">
		    <div class="leftNavMain" id="header-nav">
		      <h1><a href="#">活动</a></h1>
		      <ul>
		        <li><h2><a href="#">订货会</a></h2></li>
		        <li><h2><a href="">展会</a></h2></li>
		        <li><h2><a href="">时装周</a></h2></li>
		        <li><h2><a href="">大赛</a></h2></li>
		      </ul>
		    </div>
		  </div>
		  <!--右侧主要内容-->
	...
	//切换卡片和列表样式
	$(function(){
		$("#dis_kp").click(function(){
			$(".newsbox").show();
			
		})
		$("#dis_lb").click(function(){
			$(".newsbox").hide();
			$(".listview").show();
		})
	})
